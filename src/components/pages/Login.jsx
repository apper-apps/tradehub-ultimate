...
function Login() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-850">
      <div className="w-full max-w-md space-y-8 p-8 bg-slate-800 rounded-lg shadow-md glass-card">
